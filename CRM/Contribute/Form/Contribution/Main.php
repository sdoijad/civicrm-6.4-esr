...
class CRM_Contribute_Form_Contribution_Main extends CRM_Contribute_Form_ContributionBase {
  ...
  public function buildQuickForm() {
    ...
    if (!empty($this->_priceSetId)) {
      ...
      if (empty($this->getExistingContributionID()) || (!empty($this->_values['pledge_id']) && !empty($this->getExistingContributionID()))) {
        $this->buildPriceSet();
      }
    ...
    if (!$this->getRenewalMembershipID() && empty($this->getExistingContributionID()) || (!empty($this->_values['pledge_id']) && !empty($this->getExistingContributionID()))) {
