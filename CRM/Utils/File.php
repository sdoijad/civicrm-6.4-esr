...
HTACCESS;
  ...
  public static function baseFilePath() {
    ...
    if (!$_path) {
      ...
      // In case templates_c and Log file are at different location.
      $templateCompileDir = CIVICRM_TEMPLATE_COMPILEDIR;
      if (defined('CIVICRM_CONFIGLOGDIR') && !empty(CIVICRM_CONFIGLOGDIR)) {
        $templateCompileDir = CIVICRM_CONFIGLOGDIR;
      }
